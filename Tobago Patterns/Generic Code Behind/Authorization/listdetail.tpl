    ...
    panel$Attribute.Name.Pascal$.SetPermission<$Attribute.Type.Pascal$>(Actions.Edit);
    lbNew$Attribute.Name.Pascal$.SetPermission<$Attribute.Type.Pascal$>(Actions.Edit);
    lbSave$Attribute.Name.Pascal$.SetPermission<$Attribute.Type.Pascal$>(Actions.Edit);
    lbRemove$Attribute.Name.Pascal$.SetPermission<$Attribute.Type.Pascal$>(Actions.Remove);