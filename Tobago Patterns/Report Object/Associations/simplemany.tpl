	    ...
	    private DomainCollection<$Association.OtherEnd.Target.Name.Pascal$> $Association.OtherEnd.Role.Camel.Plural$ = new DomainCollection<$Association.OtherEnd.Target.Name.Pascal$>();
		public DomainCollection<$Association.OtherEnd.Target.Name.Pascal$> $Association.OtherEnd.Role.Pascal.Plural$
		{
			get
			{
                if (!$Association.OtherEnd.Role.Camel.Plural$.IsInitialised) 
                    $Association.OtherEnd.Role.Camel.Plural$.Initialize($Association.OtherEnd.Target.Name.Pascal$Factory.GetBy$Association.MyEnd.Role.Pascal$(this));
